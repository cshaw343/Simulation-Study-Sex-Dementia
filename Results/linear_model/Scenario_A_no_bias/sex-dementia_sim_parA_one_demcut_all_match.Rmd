...
#One simulation run
dataset <- 
  #data_gen(500000) %>% as.data.frame()
  readRDS(here("Data", "dataset_A_onedemcut_500000_20190717")) %>%
  as.data.frame()
...
knitr::include_graphics(here("DAGs", "sex-dem_sim_parA_DAG_time_updated.png"))
```
<br>
...
kable(lambda_values, 
      caption = "Baseline hazard for males in each 5-year age band") %>% 
  kable_styling()
```
