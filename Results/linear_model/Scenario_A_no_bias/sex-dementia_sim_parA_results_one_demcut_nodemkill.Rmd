...
subtitle: "One dementia cut point"
output: 
...
source(here("RScripts", "linear_model", "sex-dementia_sim_parA_onedemcut_nodemkill.R"))
...
dataset <- 
  readRDS(here(
    "Data", "linear_model",
    "dataset_A_onedemcut_nodemkill_500000_20190814")) %>% 
  as.data.frame()

#Data Analyses
sim_results <- 
  read_csv(here("Results", "linear_model", "Scenario_A_no_bias", 
