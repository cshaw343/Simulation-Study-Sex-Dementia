...
mean_sim_results <- colMeans(sim_results %>% dplyr::select(-contains("log")))
...
knitr::include_graphics(here("DAGs", "sex-dem_sim_parA_DAG_UonInt.png"))
```
<br>
...
```{r mort-HR-plots, fig.align="center", out.width = "75%", fig.cap=paste("Average simulated mortality hazard ratios for age 50+ across", runs, "simulation runs. Ages on the x-axis represent the age at the start of interval, i.e. 50 represents the mortality HR for the interval [50, 55)."), eval = FALSE}

published_HR <- Hratio_US %>%
