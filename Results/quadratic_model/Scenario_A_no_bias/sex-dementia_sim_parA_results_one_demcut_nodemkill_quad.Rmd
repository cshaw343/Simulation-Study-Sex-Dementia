...
#Life table data
US_MF <- read_csv(here("Data", "US_cohort_MF_calcs"), 
                           col_names = TRUE) %>% 
  filter(Year == "1919-1921" & Age < 100 & Age >= 50)
US_M <- read_csv(here("Data", "US_cohort_M_calcs"), 
                          col_names = TRUE) %>% 
  filter(Year == "1919-1921" & Age < 100 & Age >= 50)
US_F <- read_csv(here("Data", "US_cohort_F_calcs"), 
                          col_names = TRUE) %>% 
  filter(Year == "1919-1921" & Age < 100 & Age >= 50)
...
dataset <- 
  readRDS(here(
    ...
    "dataset_A_onedemcut_nodemkill_maleAD_500000_20190912_test")) %>% 
  as.data.frame()
