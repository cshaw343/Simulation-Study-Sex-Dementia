...
sim_results_65_plus <- sim_results %>% 
  dplyr::select(-one_of(c("logIRR_50-55", "logIRR_55-60", "logIRR_60-65"))) %>%
  dplyr::select(-contains("logIRR_CI")) %>% 
  dplyr::select(-contains("logIRR_SE")) %>% 
  dplyr::select(-one_of(c("dementia_logHR_50-55", "dementia_logHR_55-60", 
                          "dementia_logHR_60-65"))) %>%
  dplyr::select(-contains("dementia_logHR_CI")) %>% 
  dplyr::select(-contains("dementia_logHR_SE")) 
