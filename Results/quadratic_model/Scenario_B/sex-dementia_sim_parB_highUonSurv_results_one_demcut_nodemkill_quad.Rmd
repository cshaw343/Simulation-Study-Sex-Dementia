---
title: "Simulation Scenario B:  Large effect of U on survival and on cognitive intercept"
...
dataset <- 
  readRDS(here(
    ...
    "dataset_B_highUonSurv_male_AllDem_500000_20191126")) %>% 
  as.data.frame()

#Data Analyses
sim_results <-
  read_csv(here("Results", "quadratic_model", "Scenario_B", 
...
dem_table <- 
  ...
  set_rownames(c("ACT", "Simulation Scenario A", "W", "M", "Combined", 
                 "Simulation Scenario B", "W", "M", "Combined"))
...
IRR_table <- 
  ...
  t() %>% 
  set_colnames(age_labels$formatted_age_intervals) %>% 
  set_rownames(c("ACT", "IRR (Women:Men)", "Simulation Scenario B", 
                 "IRR (Women:Men)"))
