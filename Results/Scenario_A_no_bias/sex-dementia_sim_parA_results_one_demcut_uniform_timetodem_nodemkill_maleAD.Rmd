...
subtitle: "One dementia cut point; uniform time to dementia; matching male AD in EURODEM"
output: 
...
dataset <- 
  readRDS(here(
    "Data", 
    "dataset_A_onedemcut_uniform_timetodem_nodemkill_maleAD_500000_20190820")) %>% 
  as.data.frame()
...
sim_results <- 
  read_csv(
    here("Results", "Scenario_A_no_bias", 
         "one_demcut_uniform_timetodem_nodemkill_maleAD_1000_20190820.csv")) %>% 
  na.omit()
