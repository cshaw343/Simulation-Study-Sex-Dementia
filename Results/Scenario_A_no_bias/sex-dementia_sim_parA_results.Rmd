...
dataset <- 
  readRDS(here(
    "Data", "quadratic_model", "dataset_A_male_AllDem_500000_20191125")) %>% 
  as.data.frame()
...
Table \@ref(tab:Lambda-values) shows the computed values of $\lambda_j$ for our hazard function.  The values for each of the coefficients in the hazard function are displayed in Table \@ref(tab:mort-haz-coeff).  In Table \@ref(tab:mort-haz-coeff), $\gamma_{10}-\gamma_{19}$ represent the age-specific effect of being a woman on mortality.  Note that $\gamma_2$ and $\gamma_3$ are set to 0 in Simulation Scenario A signifying that in this scenario, there is no effect of U on mortality. 
