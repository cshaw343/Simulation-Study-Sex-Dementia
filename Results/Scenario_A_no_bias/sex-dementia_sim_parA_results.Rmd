...
```{r survival-plots, fig.show="hold", out.width="50%", fig.cap="Average simulated cumulative survival probabilites from age 50 years across 100 iterations of sample generation"}
...
Average dementia incidence rates per 1000 person years across 100 simulated samples are displayed in Table \@ref(tab:dem-inc-rates). The dementia incidence rates from the EURODEM study, used as reference, are displayed in the first line of the table. The average dementia hazard ratios across 100 simulated scenarios are displayed in Table \@ref(tab:hr-table), and the average incidence rate ratios are displayed in Table \@ref(tab:IRR-table).  In both cases, ratios are presented as female:male.
...
kable(hr_table, caption = "Average hazard ratios for dementia (exponentiated mean of the observed ln(dementia HR) across 100 simulated samples).") %>% 
  kable_styling()
```
...
kable(IRR_table, caption = "Average incidence rate ratios for dementia (exponentiated mean of the observed ln(dementia IRR) across 100 simulated samples).") %>% kable_styling()
```
