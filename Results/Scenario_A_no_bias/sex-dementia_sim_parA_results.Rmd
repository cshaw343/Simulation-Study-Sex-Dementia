...
#One simulation run
dataset <- readRDS(here("Data", "dataset_A_500000_20200223")) %>% 
  as.data.frame()

#Data Analyses
sim_results <- read_csv(here("Results", "Scenario_A_no_bias", 
                             "sim_A_male_1000_20191125.csv")) 
...
knitr::include_graphics(here("DAGs", "scenario_A_DAG.png"))
```
<br>
...
kable(lambda_values, 
      caption = "Baseline hazard for men in each 5-year age band") %>% 
  kable_styling()
```
