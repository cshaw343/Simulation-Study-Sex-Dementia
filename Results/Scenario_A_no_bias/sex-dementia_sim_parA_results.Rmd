...
#Data Analyses
#sim_results <- readRDS(here("Data", "logIRRs_A_20190304"))
```
...
#Cohort Description 
The results in this summary are based on 100 simulated cohorts of n = `r formatC(nrow(test_data), format = "d", big.mark = ",")` 50 year old individuals who were followed for up to 45 years with assessments for dementia status every five years. Dementia incidence rate = _____. 
