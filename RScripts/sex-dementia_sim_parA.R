...
best_slopes_cuts[5:10, "slope"] <- 0
best_slopes_cuts[5:10, "dem_cut"] <- best_slopes_cuts[4, "dem_cut"]
...
dem_cuts <- head(c(best_slopes_cuts$dem_cut[1], best_slopes_cuts$dem_cut), -1)
