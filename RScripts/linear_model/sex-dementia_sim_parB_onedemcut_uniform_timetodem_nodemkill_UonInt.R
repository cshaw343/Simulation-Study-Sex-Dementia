...
#For total matching
cij_var1 <- c(0.001, #Need this for the noise term for the baseline measure
              rep(0.001, 3), 0.009, 0.065, 0.26, 0.750, 1.6, 3.6) #Time-dependent variance of random cognitive slope
...
#For total matching
cij_slopes <- c(rep(-0.005, 2), -0.01, -0.02, -0.025, -0.04, -0.06, -0.22, -0.4) 
...
g1 <- log(c(0.5297, 0.4678, 0.4126, 0.4181, 0.4228, 0.4577, 0.4997, 0.5558, 
            0.6744)) 
...
#For total matching
lambda <- c(0.0058, 0.0094, 0.0159, 0.0260, 0.0437, 0.0752, 0.1321, 0.2445, 
            0.4887)
