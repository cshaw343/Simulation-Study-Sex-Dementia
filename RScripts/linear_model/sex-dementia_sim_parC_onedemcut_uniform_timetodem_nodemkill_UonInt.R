...
#For total matching
cij_var1 <- c(0.001, #Need this for the noise term for the baseline measure
              rep(0.001, 3), 0.009, 0.065, 0.27, 0.82, 1.8, 4.27) #Time-dependent variance of random cognitive slope
...
#For total matching
cij_slopes <- c(rep(-0.005, 2), -0.01, -0.02, -0.01, -0.02, -0.04, -0.22, -0.4) 
