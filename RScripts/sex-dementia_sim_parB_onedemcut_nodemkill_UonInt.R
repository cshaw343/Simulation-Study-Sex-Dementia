...
#For total matching
cij_var1 <- c(0.001, #Need this for the noise term for the baseline measure
              rep(0.001, 3), 0.009, 0.07, 0.26, 0.750, 1.6, 3.6) #Time-dependent variance of random cognitive slope
...
#For total matching
cij_slopes <- c(rep(-0.005, 2), -0.01, -0.02, -0.03, -0.04, -0.06, -0.22, -0.35) 
...
#For total matching
lambda <- c(0.006, 0.01, 0.014, 0.026, 0.044, 0.075, 0.135, 0.243, 0.55)
