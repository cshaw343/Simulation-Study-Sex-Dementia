...
source(
  here("RScripts", "quadratic_model", 
       "sex-dementia_sim_parB_highUonSurv_onedemcut_nodemkill_male_AllDem_quad.R"))  #The parameter file
...
data_gen(500000) %>%
  saveRDS(here("Data", "quadratic_model",
               "dataset_B_onedemcut_nodemkill_male_AllDem_500000_20191116"))
...
write_csv(sim_results, 
          here("Results", "quadratic_model", "Scenario_B_highU", 
               "one_demcut_nodemkill_highUonSurv_male_AllDem_1000_20191116.csv"))
