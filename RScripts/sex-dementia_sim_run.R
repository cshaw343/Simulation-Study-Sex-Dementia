...
source(
  here("RScripts", "quadratic_model", 
       "sex-dementia_sim_parB_onedemcut_nodemkill_male_AllDem_quad.R"))  #The parameter file
...
data_gen(500000) %>%
  saveRDS(here("Data", "quadratic_model",
               "dataset_B_male_AllDem_500000_20191128"))
...
write_csv(sim_results, 
          here("Results", "quadratic_model", "Scenario_B", 
               paste0("sim_B_highUonSurv_male_AllDem_", runs, "_20191128.csv")))
