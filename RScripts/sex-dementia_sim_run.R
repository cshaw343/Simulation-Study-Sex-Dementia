...
source(
  here("RScripts", 
       "sex-dementia_sim_parA_onedemcut_nodemkill_UonInt.R"))  #The parameter file
...
data_gen(500000) %>%
  saveRDS(here(
    "Data", 
    "dataset_A_onedemcut_nodemkill_UonInt_500000_20190820"))
...
sim_results <- parSapply(cl, 1:runs, function(i) {sex_dem_sim(100000)}) %>% 
  ...
  write_csv(
    here("Results", "Scenario_A_no_bias", 
         "one_demcut_nodemkill_UonInt_1000_20190820.csv"))
