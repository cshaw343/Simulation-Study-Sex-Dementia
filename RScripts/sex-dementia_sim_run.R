...
<<<<<<< HEAD
data_gen() %>% saveRDS(here("Data", "dataset_A_onedemcut_20190624"))
=======
data_gen(num_obs) %>% saveRDS(here("Data", "dataset_A_onedemcut_20190623"))
>>>>>>> ad123eed7ebb9aec63f6c103e99515b85ade0f56
