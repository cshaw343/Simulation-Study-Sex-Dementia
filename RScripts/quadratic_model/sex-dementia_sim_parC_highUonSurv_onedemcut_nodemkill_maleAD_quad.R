...
b20 <- -0.0031225 #Cognitive quadratic term for males 
...
g1 <- log(c(1.8097981, 1.4515910, 1.1739980, 0.9308336, 0.6806402, 0.4673085, 
            0.2959380, 0.1749380, 0.0890115)) 
...
#For male matching
lambda <- c(0.00713453, 0.01248570, 0.02237908, 0.04277020, 0.09123388, 
            0.19967464, 0.48926106, 1.22213058, 3.36050028)
