...
b20 <- -0.0028   #Cognitive quadratic term for males 
...
g1 <- log(c(1.160264, 1.063264, 1.002552, 0.943113, 0.835486, 0.704947, 
            0.606099, 0.440200, 0.286078)) 
...
#For male matching
lambda <- c(0.0112763, 0.0170696, 0.0258732, 0.0422265, 0.0746031, 0.1317517, 
            0.2505832, 0.4776780, 0.9457229)
